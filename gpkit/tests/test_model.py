...
class TestModelGraph:
    ...
    def test_single_child_in_children(self):
        ...
        assert a._children[0] is a.wing
        assert a._child_attrs["wing"] is a.wing
    ...
    def test_two_children_order_preserved(self):
        ...
        assert t._children[0] is t.a
        assert t._children[1] is t.b

    def test_child_attrs_multiple_same_class(self):
        ...
        t = _MGMultiTop()
        assert "sub1" in t._child_attrs
        assert "sub2" in t._child_attrs
        assert t._child_attrs["sub1"] is not t._child_attrs["sub2"]
...
class TestSubmodels:
    ...
    def test_budget_rollup_pattern(self, solver):
